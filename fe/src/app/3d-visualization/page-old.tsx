...
const SCENE_SCALE = 1e-10; // 1 scene unit ≈ 10^10 meters

// Time Scale Factor
// Real orbital periods are in days/months/years, which is too slow for visualization
// This multiplier accelerates time for visible motion
const TIME_SCALE = 86400 * 3; // Accelerate time by ~3 days per second (259,200x)
...
export default function ThreeDVisualization() {
  ...
  const [speedMultiplier, setSpeedMultiplier] = useState(1); // Default 1x (base TIME_SCALE is already fast)
