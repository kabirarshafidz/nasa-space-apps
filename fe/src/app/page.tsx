...
export default function HomePage() {
	...
	return (
		<div className="h-screen overflow-hidden flex flex-col justify-center pl-24 px-40">
			<div className="mb-12">
				<h1 className="text-7xl font-bold mb-4">Discover New Worlds</h1>
				<p className="text-xl max-w-3xl">
					Use machine learning to predict exoplanets or train your own model
					with scientific data. Upload CSVs, visualize predictions, and explore
					the cosmos through data.
				</p>
			</div>

			{/* Cards Section */}
			<div className="flex gap-6 justify-start items-stretch max-w-5xl">
				{/* Train Card */}
				<div
				...
				>
					...
					<div className="relative flex h-full flex-col items-start justify-between overflow-hidden rounded-2xl border border-gray-700 bg-black/40 backdrop-blur-sm px-6 py-6">
						...
						<p className="relative z-50 text-sm font-normal text-slate-400">
							Upload your dataset and train a custom ML model to discover
							exoplanets.
						</p>
				...
				>
					...
					<div className="relative flex h-full flex-col items-start justify-between overflow-hidden rounded-2xl border border-gray-700 bg-black/40 backdrop-blur-sm px-6 py-6">
						...
						<p className="relative z-50 text-sm font-normal text-slate-400">
							Use pre-trained models to predict exoplanets from observation
							data.
						</p>
